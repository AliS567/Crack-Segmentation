...
def get_model(n_ch, patch_height, patch_width):
    ...
    conv1 = LeakyReLU(alpha=LRUA)(conv1)
    ...
    conv2 = LeakyReLU(alpha=LRUA)(conv2)
    ...
    conv3 = LeakyReLU(alpha=LRUA)(conv3)
    ...
    conv4 = LeakyReLU(alpha=LRUA)(conv4)
    ...
    conv5 = LeakyReLU(alpha=LRUA)(conv5)
    ...
    conv6 = LeakyReLU(alpha=LRUA)(conv6)
